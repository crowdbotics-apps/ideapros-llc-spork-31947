...
## Project Structure
    ...
    ├── ideapros_llc_spork_31947  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_spork_31947`
...
2. Clone this repo and `cd ideapros_llc_spork_31947`
